...
export const Uppgift2 = () => {
	...
	const [fornamn, uppdateraFornamn] = useState("Dunia")

	return (
		<div>
			<h1>Uppgift 2</h1>
			<h2>{fornamn}</h2>
			<input onChange ={event => uppdateraFornamn(event.target.value)} placeholder="Denna input skall uppdatera värdet som matas in till ditt state"  />
		</div>
	)
}
